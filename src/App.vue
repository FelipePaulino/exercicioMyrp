...
interface Item {
  nome: string;
  descricao: string;
  prateleira: number | null; // ajustado para number | null se prateleira for um número em seus dados
  galpao: string;
...
export default defineComponent({
  ...
  methods: {
    ...
    addItem(): void {
      ...
      const trimmedPrateleira =
        this.newItem.prateleira !== null
          ? String(this.newItem.prateleira).trim()
          : null;
